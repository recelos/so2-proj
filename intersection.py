...
class Intersection:
    ...
    def draw_intersection(self, canvas):
        ...
        canvas.create_line(350, 350, 450, 350, fill="grey", width=1, dash=(3, 3))
        ...
        canvas.create_line(350, 250, 450, 250, fill="grey", width=1, dash=(3, 3))
        ...
        canvas.create_line(350, 250, 350, 450, fill="grey", width=1, dash=(3, 3))
        ...
        canvas.create_line(450, 250, 450, 350, fill="grey", width=1, dash=(3, 3))
