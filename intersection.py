...
class Intersection:
    ...
    def draw_intersection(self, canvas):
        # middle square
        canvas.create_rectangle(450, 350, 350, 250, fill="grey", outline="")
        # grass
        ...
        canvas.create_line(350, 350, 450, 350, fill="white", width=1, dash=(3, 3))
        ...
        canvas.create_line(350, 250, 450, 250, fill="white", width=1, dash=(3, 3))
        ...
        canvas.create_line(350, 250, 350, 350, fill="white", width=1, dash=(3, 3))
        ...
        canvas.create_line(450, 250, 450, 350, fill="white", width=1, dash=(3, 3))
